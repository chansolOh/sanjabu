...
class RobotTask(tasks.BaseTask):
    ...
    def set_up_scene(self, scene: Scene) -> None:
        ...
        self.gripper_grasp_position = np.array([-0.045,0.045])
    ...
    def set_robot(self) -> SingleManipulator:
        self.gripper_model = "Custom_onrobot"
        self.asset_root_path = f"/media/nia/SSD1/ochansol_pc2/isaac/sanjabu/Robot/{self.gripper_model}"
        self.usd_path = f"{self.asset_root_path}/{self.gripper_model}.usd"
        # self.asset_path = "/ochansol/isaac/USD/robots/Doosan_M1013/M1013_robotiq_gripper.usd"
        # self.asset_path = "/ochansol/isaac/USD/robots/Doosan_M1013/M1013_origin.usd"
        finger_physics_mat_path = f"/World/{self.gripper_model}/Body/gripper/PhysicsMaterial"
        add_reference_to_stage(usd_path=self.usd_path, prim_path=self.usd_prim_path)
        gripper = ParallelGripper(
            end_effector_prim_path=f"/World/{self.gripper_model}/Body/gripper/onrobot_2fg_14/base",
    ...
    def set_solver(self):
        kinematics_solver = LulaKinematicsSolver(
                            # robot_description_path="/ochansol/isaac/USD/robots/Doosan_M1013/Doosan_M1013_description.yaml",
                            # urdf_path="/ochansol/isaac/USD/robots/Doosan_M1013/M1013_robotiq_gripper.urdf",
                            robot_description_path  =f"{self.asset_root_path}/{self.gripper_model}_description.yaml",
                            urdf_path               =f"{self.asset_root_path}/{self.gripper_model}.urdf",
        )
    ...
    def set_contact_sensor(self):
        ...
        self.gripper_L_path = f"/World/{self.gripper_model}/Body/gripper/onrobot_2fg_14/Left"
        self.gripper_R_path = f"/World/{self.gripper_model}/Body/gripper/onrobot_2fg_14/Right"
        # gripper_palm_path = "/World/Doosan_M1013/gripper/onrobot_2fg_14/base/_114001_1_STEP_88/NONE_89"
        
        self._contact_sensor_path_L = os.path.join(self.gripper_L_path, "_114008_1_STEP_26/NONE_15/Contact_Sensor")
        self._contact_sensor_path_R = os.path.join(self.gripper_R_path, "_114008_1_STEP_14/NONE_15/Contact_Sensor")

...
# scene_num = 0
root_path = "/media/nia/SSD1/ochansol_pc2/isaac/sanjabu/Dataset_2024/scene_rev20241209/Home/"
...
for obj in obj_conf:
    ...
    path = obj["usd_path"]
    path = "/media/nia/SSD1/ochansol_pc2/3d_model/peel3_scan_data"+path.split("scan_data_2204")[-1]

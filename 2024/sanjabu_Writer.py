...
import sys
sys.path.append("/home/cubox/.local/share/ov/pkg/isaac-sim-4.2.0/extscache/omni.replicator.core-1.11.20+106.1.0.lx64.r.cp310/omni/replicator/core/scripts/writers_default")
...
class SanjabuWriter(BasicWriter):
    ...
    def set_path(self, output_path,
                 ...
                 distance_to_camera_path="distance_to_camera",
                 distance_to_image_plane_path="depth",
                 semantic_segmentation_path="sem_seg",
                 instance_segmentation_path="inst_seg",
                 bounding_box_path="bbox",
                 camera_params_path="cam_params",
        ...
        self.distance_to_camera_path = distance_to_camera_path
        self.distance_to_image_plane_path = distance_to_image_plane_path
    ...
    def _write_occlusion(self, anno_rp_data: dict, output_path: str):
        ...
        file_path = f"{self.output_path}occlusion_{self._sequence_id}{self._frame_id:0{self._frame_padding}}.npy"
    ...
    def _write_camera_params(self, anno_rp_data: dict, output_path: str):
        ...
        file_path = f"{self.output_path}camera_params_{self._sequence_id}{self._frame_id:0{self._frame_padding}}.json"

...
###### data path ######
dir_path = "scene_bak_20241128/Home" 
rgb_path = os.path.join(root_path, dir_path, "rgb/cam_00")
bbox_path  = os.path.join(root_path, dir_path, "bbox/cam_00")



class bbox_display():
    def __init__(self, rgb_path, bbox_path, sampling_num, all_data_num):
    ...
    def data_load(self, scene_num):
        ...
        with open(os.path.join(self.bbox_path, f"bbox_{scene_num:04d}.json")) as f:
...
bbox_display(rgb_path, bbox_path, sampling_num, all_data_num)
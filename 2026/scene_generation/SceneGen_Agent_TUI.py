...
class MultiPCController(App):
    ...
    def __init__(self, **kwargs):
        ...
        # Environment 딕셔너리
        self.env_dict = {
            "Home": {"LivingRoom_Kitchen": {}, "MasterBedroom":{}},
            "Logistic_site": {"FOODnamoo": {}, "General_LogisticSite": {}},
            "Manufactory": {"FOODnamoo_poultry_plant": {}, "Seongju_Melon_Processing_Facility": {}},
        }
